...
cat("Sense disagreements:", n_disagreement, "| resolved via referee:", n_disagreement - n_unresolved, "| unresolved:", n_unresolved, "\n")
...
write.csv(df, file = "../output/data/corpus_v3.csv", quote = T, row.names = F)
