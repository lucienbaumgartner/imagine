...
(L2) regularization. Cluster assignment from the GMM served as the
dependent variable. Predictors included all three annotation dimensions
and their pairwise interactions. Regularization strength was selected
via cross-validation to promote coefficient stability. Because latent
sense labels were constructed via clustering in the same annotation
space used as predictors, the observed predictive performance does not
provide independent evidence about the determinants of sense membership.
Rather, the multinomial model serves a descriptive role, summarizing how
